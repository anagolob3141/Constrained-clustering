...
populacije_krajev_koord <- read_delim("eksperiment_volitve/uvoz/populacije_krajev.csv", 
                                ";", escape_double = FALSE, 
...
# Opomba: lahko bi bolj preprosto uporabili funkcijo "geocode" na tabeli, vendar sem zelel,
